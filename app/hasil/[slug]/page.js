        ...
        <div className="w-screen  bg-slate-500">
            ...
            <div className="flex align-middle justify-center ">
                <div className={Styles.hlog}>
                    ...
                    Hasil ki na qadri or la-hasil ki qadr yeh ek aam cheez hu gae hai.<br/><br/>
                    ...
                    In sare kyu ka jawab dena koi lafzo ka khel nahi yeh jo kyu ulfat se jude hute hai unka jawab hargiz nahi huta yeh lafzo mein nahi ehsass se samjhe jate hai or yeh ehsass duniya ke har us lafzo per bhari hai jo is kyu ka jawab dena chahe per is ehsass se maar kha jate hai.<br/><br/>
                    Mudda yeh hai ke jab woh hame hasil hu jate hai toh kuch kehte hai ab unme woh baat nahi, main kehti hu kya aapki chahat mein woh baat hi nahi thi jo aap hasil ke baad use faramoosh kr de rahe hai. Hqeeqat toh yeh hai ke jab man pasand shaks hasil hujae toh uski qadr o izzat dogni hu jati hai. Yahi toh asal chahat huti hai jo kabhi khtm nahi huti is jahan se us jahan taak aap ki sanso mein rachi basi huti hai.<br/><br/>
                    Ager hasil kr uski qadr kho dete hai toh yaqeen mane aap ne kabhi us se sacchi ulfat ki hi nahi thi. Hasil ki qadar kerna unhi ki fitrat huti hai jinki fitrat, tarbiyat, or chahat azeem huti hai.<br/><br/>
                    Jab sukoon or be-sukooni ek hi zaat se wabasta hu jae toh fir kuch yu huta hai<br/><br/>
